...
public class NeighboursListTest {
    ...
    /**
     * When we clicked on element view, show new activity with details of neighbour
     */
    ...
    public void detailsNeighbour_Firstname() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.firstname), withText("Caroline"),
                        childAtPosition(
    ...
    public void myFavoriteListTest() {
        ...
        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.favorite_btn),
                        childAtPosition(
                                childAtPosition(
